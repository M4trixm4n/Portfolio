...
# assert "cp ./TEST1/diff.png localdiff.png"
...
# assert "./checktriplet.sh \"1 1 1,mul,2\"" "2.0 2.0 2.0"
# assert "./checktriplet.sh \"1 1 1,sub,2 2 2\"" "-1.0 -1.0 -1.0"
# assert "./checktriplet.sh \"1 1 1,add,2 2 2\"" "3.0 3.0 3.0"
# assert "./checktriplet.sh \"1 1 1,sub,2 2 2\"" "-1.0 -1.0 -1.0"
# assert "./checktriplet.sh \"1 1 1,dot,2 2 2\"" "6.0"
# assert "./checktriplet.sh \"1 0 0,cross,0 1 0\"" "0.0 0.0 1.0"
